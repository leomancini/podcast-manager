...
class UploadHandler{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../content/episodes/',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
		...
		$file_extension_tmp = explode('.', $name);
		$file_extension = end($file_extension_tmp);
		$date_uploaded = date("m-d-y");
		$random_file_name = rand(0, 99999999999999);
        $file->name = $date_uploaded."-".$random_file_name.".".$file_extension;
    ...
    protected function handle_form_data($file, $index) {
		...
		$query = $db->prepare("INSERT INTO episodes (name, date_shown, description, file_name, uploaded_datetime) VALUES (?, ?, ?, ?, ?)");
		$query->bind_param("sssss", $name, $date_shown, $description, $file_name, $uploaded_datetime);
		
		$name = $_POST["name"];
		$date_shown = $_POST["date_shown"];
